...
int opendevice(int camid, int videoid)
{
	...
	sprintf(system_call_buffer,"su -c \"chmod 666 %s\"",dev_name[camid]);
...
void Java_com_BulaMeihsner_eyetracker_CameraCapture_pixeltobmp( JNIEnv* env,jobject thiz,jobject bitmap1, jobject bitmap2){
...
jint Java_com_BulaMeihsner_eyetracker_CameraCapture_prepareCamera(JNIEnv* env,jobject thiz, jint videoid){
...
jint Java_com_BulaMeihsner_eyetracker_CameraCapture_prepareCameraWithBase( JNIEnv* env,jobject thiz, jint videoid, jint videobase){
	
	int ret;

	camerabase = videobase;

	return Java_com_BulaMeihsner_eyetracker_CameraCapture_prepareCamera(env,thiz,videoid);

}

void Java_com_BulaMeihsner_eyetracker_CameraCapture_processCamera( JNIEnv* env,jobject thiz){
...
void Java_com_BulaMeihsner_eyetracker_CameraCapture_stopCamera(JNIEnv* env,jobject thiz){
...
void Java_com_BulaMeihsner_eyetracker_CameraCapture_processRBCamera( JNIEnv* env,jobject thiz, jint lrmode){
	int i;
	int red = 1-lrmode;
	int blue = lrmode;
